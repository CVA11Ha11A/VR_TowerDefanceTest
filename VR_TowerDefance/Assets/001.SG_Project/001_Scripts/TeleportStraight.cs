...
public class TeleportStraight : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (ARAVRInput.GetUp(ARAVRInput.Button.One, ARAVRInput.Controller.LTouch))
        {
            ...
            }       // if : 오프 기능이 사용중이지 않을 때
            else
            {
                // 워프 기능을 사용할 때는 Warp() 코루틴 콜
                StartCoroutine(Warp());
            }
    ...
    private IEnumerator Warp()
    {
        ...
        // 목적지
        Vector3 targetPos = teleportCircleUI.position;
        // 워프 경과시간
        float currentTime = 0f;

        // 포스트 프로세싱에서 사용중인 프로파일에서 모션불러 얻어오기
        ...
        while (currentTime < warpTime)
        {
            ...
            // 워프의 시작점에서 도착점에 도착하기 위해 워프시간동안 이동
